    ...
    <nav class="navbar navbar-light bg-faded navbar-full fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="login">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link mx-3 my-3 font-weight-bold" href="profile.php" style="font-family: 'Roboto Slab', serif;">
                        Home <span class="sr-only">(current)
                    </span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-3 my-3 font-weight-bold" href="modules/user/updateprofile.php" style="font-family: 'Roboto Slab', serif;">
                        Edit Profile</a>
                </li>
                <li class="nav-item">
            ...
            <a class="navbar-brand mr-auto" href="#"><img src="images/AbcLogo.png" alt="ABC Jobs"></a>
            ...
            <div class="navbar-nav ml-auto">
                <form method="post" class="form-inline" action="login.php">
                    ...
                    <div class="form-group ">
                        ...
                        <a href="modules/user/forgetpasswd.php" style="font-family: 'Roboto Slab', serif;">Forget
                            Password?</a>
                    </div>
                </form>
            </div>
